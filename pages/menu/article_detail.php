...
if (empty($slug)) {
    header("Location: https://produsenkubahmasjid.id/pages/menu/blog.php");
    exit;
}

// Fetch single article from database
$sql = "SELECT * FROM articles WHERE slug = '$slug' AND published = 1 LIMIT 1";
            ...
            <div class="content-area grid-parent mobile-grid-100 grid-75 tablet-grid-75" id="primary">
                <main class="site-main" id="main">
                    ...
                    <article id="post-<?php echo $article['id']; ?>"
                        class="post-<?php echo $article['id']; ?> post type-post status-publish format-standard hentry"
                        ...
                        <div class="inside-article">
                            ...
                            <div class="entry-content" itemprop="text">
                                ...
                                <!-- Full article content from CKEditor -->
                                <?php echo $article['content']; ?>
                            </div>

                            <footer class="entry-meta" aria-label="Entry meta">
                                <p style="margin-top: 30px;">
                                    <a href="https://produsenkubahmasjid.id/pages/menu/blog.php" class="read-more-link">
