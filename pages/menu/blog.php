                                ...
                                <article id="post-<?php echo $article['id']; ?>"
                                    ...
                                    <div class="blog-card-image">
                                        <?php if (!empty($article['featured_image'])): ?>
                                            <img decoding="async"
                                                ...
                                                src="https://produsenkubahmasjid.id/<?php echo htmlspecialchars($article['featured_image']); ?>" />
                                        <?php else: ?>
                                            <img decoding="async"
                                                loading="lazy"
                                    ...
                                    <div class="blog-card-content">
                                        ...
                                        <h2 class="blog-card-title" itemprop="headline">
                                            <a href="https://produsenkubahmasjid.id/pages/menu/article_detail.php?slug=<?php echo urlencode($article['slug']); ?>"
                                                rel="bookmark">
